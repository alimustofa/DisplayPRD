<?php
	...
	echo "
	<script>
		document.title = 'Ganti Background | DISPLAY PRD'
	</script>
	<script>
		...
		<div class='title-admin'>
			<div style='padding:20px; height:142px; background:rgba(0,0,0,0.4)'>
				<div style='font-size:70px; margin-right:15px; margin-top:10px;' class='f-putih f-symbol'>?</div>
					<div class='f-putih f24 f-segoe' style='padding:15px; margin-top:50px;'>Tambah Galeri Video<br><div style='margin-top:7px;' class='f-segoe f-putih f16'><i>Form untuk mengganti background front end...</i></div></div>
			</div>
		</div>
		...
		<div class='wrapper-tengah'>
			...
			<div class='title-form'><span class='f-symbol mr10'>?</span>GANTI BACKGROUND</div>
				<div class='pd15'>
					<div class='psn'></div>
					<form method='POST' action='aksi_ganti_background' id='form_input' enctype='multipart/form-data'>
						<div class='form-grup'>
							<div class='label-form'>FOTO</div>
							<img src='_asset/_images/_background/$back[background]' id='gbr' width='450px' style='border:solid 1px #ccc; padding:10px; background:#eee;'>
							<br><br>
